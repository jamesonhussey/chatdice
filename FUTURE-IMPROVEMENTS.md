...
## 🛡️ Safety & Moderation
- [ ] Profanity filter API integration (CleanSpeak, Perspective API)
...
- [ ] Language selection
- [ ] Share chat transcript (anonymized)
- [ ] Dark mode

## 📱 Technical
- [ ] PWA features (installable app, offline support)
- [ ] Image compression for favicon (ICO format)
- [ ] Social share image (Open Graph)
- [ ] Uptime monitoring setup (UptimeRobot)

## 🚀 Marketing
- [ ] Launch on Product Hunt
- [ ] Submit to AlternativeTo.net (Omegle alternative)
